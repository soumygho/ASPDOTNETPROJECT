...
function(h,e,g,j){function i(){for(n=0;n<w;n++)E=m.length,0<E?(A=Math.floor(Math.random()*E),m[A].visible=!0,m.splice(A,1)):n=w;D++;if(D>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(u);u=null}}for(var f=h.getChildAt(0),k=f.image,l=Math.ceil(e/20),p=Math.ceil(g/20),n=0,o=0,m=[],n=0;20>n;n++)for(o=0;20>o;o++){var q=l*n,r=p*o,s=l,t=p;if(q<e&&
r<g)q>e-l&&(s=e-q),r>g-p&&(t=g-r),s=new Quark.Bitmap({id:"maskBitmap"+n+o,image:k,rect:[q,r,s,t]}),s.x=q,s.y=r,s.visible=!1,h.addChild(s),m.push(s)}c=j*b;d=1/c;var u=setInterval(i,1E3/b),D=1,E=m.length,A,w=Math.round(E/c);1>w&&(w=1);i()};this.mask13=function(h,e,g,j){function i(){k=e/2*(1-m*d);l=g/2*(1-m*d);p=e*m*d;n=g*m*d;f.x=e/2*(1-m*d);f.y=g/2*(1-m*d);f.setRect([k,l,p,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,g]),
...
0,clearInterval(o),o=null}var f=h.getChildAt(0),k=0,l=g,p=0,n=0;c=j*b;d=1/c;var o=setInterval(i,1E3/b),m=1;i()};this.mask24=function(h,e,g,j){function i(){q=e/2*F*d;r=g/2*F*d;f.setRect([o,m,q,r]);s=e/2+e/2*(1-F*d);t=0;u=e/2*F*d;D=g/2*F*d;l.x=e/2+e/2*(1-F*d);l.setRect([s,t,u,D]);E=0;A=g/2+g/2*(1-F*d);w=e/2*F*d;v=g/2*F*d;p.y=g/2+g/2*(1-F*d);p.setRect([E,A,w,v]);z=e/2+e/2*(1-F*d);C=g/2+g/2*(1-F*d);y=e/2*F*d;B=g/2*F*d;n.x=e/2+e/2*(1-F*d);n.y=g/2+g/2*(1-F*d);n.setRect([z,C,y,B]);F++;if(F>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(G);G=null}}var f=h.getChildAt(0),k=f.image,l=new Quark.Bitmap({id:"targetBitmap2",image:k,rect:[0,0,0,0]});h.addChild(l);var p=new Quark.Bitmap({id:"targetBitmap3",image:k,rect:[0,0,0,0]});h.addChild(p);var n=new Quark.Bitmap({id:"targetBitmap4",image:k,rect:[0,0,0,0]});h.addChild(n);var o=0,m=0,q=0,r=0,s=e,t=0,u=0,D=0,E=0,A=g,w=0,v=0,z=e,C=g,y=0,B=0;c=j*b;d=1/c;var G=setInterval(i,1E3/b),F=1;i()};this.mask25=
function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask26=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask27=function(h,e,g,j){function i(){for(var b=0;b<l;b++){var i=p*b,j=p;n[b].x>e-p&&(j=e-n[b].x);var k=o[b]+(g-o[b])*u*d*g/(g-o[b]);k<g&&n[b].setRect([i,0,j,k])}u++;if(u>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(t);t=null}}for(var f=
...
a,b,c,d)};this.mask66=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask67=function(a,b,c,d){this.transition(68,a,b,c,d)};this.mask68=function(h,e,g,j){function i(){for(n=0;n<F;n++)m[n].width=u[n]*G*d,m[n].height=D[n]*G*d,m[n].x=s[n]+(q[n]-s[n])*G*d,m[n].y=t[n]+(r[n]-t[n])*G*d;G++;if(G>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,g]);1<h.getNumChildren();)h.removeChildAt(h.getNumChildren()-1);clearInterval(B);
B=null}}for(var f=h.getChildAt(0),k=f.image,l=Math.ceil(e/12),p=Math.ceil(g/12),n=0,o=0,m=[],q=[],r=[],s=[],t=[],u=[],D=[],n=0;12>n;n++)for(o=0;12>o;o++){var E=l*n,A=p*o,w=l,v=p,z=Math.random()*(e-l),C=Math.random()*(g-p);if(E<e&&A<g){E>e-l&&(w=e-E);A>g-p&&(v=g-A);var y=new Quark.Bitmap({id:"maskBitmap"+n+o,image:k,rect:[E,A,w,v]});y.x=z;y.y=C;y.width=0;y.height=0;h.addChild(y);m.push(y);q.push(E);r.push(A);u.push(w);D.push(v);s.push(z);t.push(C)}}c=j*b;d=1/c;var B=setInterval(i,1E3/b),G=1,F=m.length;
...
0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=s+(w-a.width)/2;a.y=q+(v-a.height)/2;K.addChild(a)}}function g(){if(""!=D){var a=K.getChildById("preloader");null!=a&&K.removeChild(a)}}var j=b.frameRate,i=b.photoArray,f=b.photoUrlArray,k=b.enableURL,l=b.URLTarget,p=b.photoTimeArray,n=b.transitionArray,o=b.defineTransitionArray,m=b.transitionTimeArray,q=b.topPadding,r=b.bottomPadding,s=b.leftPadding,t=b.rightPadding,u=b.randomPlayingPhotos,
...
(B=1,L.maskerFull=1):B=1};this.Show=function(a,b){z=b;1==C&&1==y?(clearInterval(H),H=null,x=a,d()):1==C&&0==y?(B=1,x=a,L.maskerFull=1):(x=a,B=1)}}})();(function(){aJSs.JsDescription=function(b,a){function c(b){q=l[b.index];""!=q?(b=w.getChildById("description"),w.removeChild(b),b=new Quark.Bitmap({id:"description",image:h(k,f,i,q)}),w.addChild(b),v.height=t,A.y="top"==e?n:a.height-o-t,A.visible=!0):(A.visible=!1,t=0,v.height=0)}function d(a,b,c){var d=document.createElement("canvas");d.width=a;d.height=b;var e=d.getContext("2d");e.fillStyle=c;e.rect(0,0,a,b);e.fill();c=new Image;c.src=d.toDataURL("image/png");c.width=a;c.height=b;return c}function h(b,
c,d,e){var f=document.createElement("canvas");f.width=a.width;f.height=a.height;var g=f.getContext("2d");g.font=c+"px "+d;g.textAlign="start";g.textBaseline="top";g.fillStyle=b;for(var c=b=r,d=D,h=p,e=e.split(" "),i="",j=1,l=0;l<e.length;l++){var k=i+e[l]+" ";g.measureText(k).width>d?(g.fillText(i,b,c),i=e[l]+" ",c+=h,j++):i=k}g.fillText(i,b,c);E=j*h;t=E+2*r;t>u&&(t=u);g=new Image;g.src=f.toDataURL("image/png");g.width=s;g.height=t;return g}var e=b.desAlign,g=b.desBackgroundColor,j=b.desBackgroundAlpha,
i=b.desTextFont,f=b.desTextSize,k=b.desTextColor,l=b.descriptionText,p=b.desLineHeight,n=b.topPadding,o=b.bottomPadding,m=b.leftPadding,q=l[0],r=4,s=a.width-m-b.rightPadding,t=0,u=a.height-n-o,D=s-2*r,E;if("true"==b.enableDes){var A=new Quark.DisplayObjectContainer({id:"desContainer"});A.autoSize=!0;A.visible=!1;A.x=m;A.y="top"==e?n:a.height-o-t;a.addChild(A);var w=new Quark.DisplayObjectContainer({id:"desBox"});w.autoSize=!0;A.addChild(w);var v=new Quark.Bitmap({id:"desBackground",image:d(s,p,g)});
v.autoSize=!0;v.alpha=j;w.addChild(v);g=new Quark.Bitmap({id:"description",image:h(k,f,i,q)});w.addChild(g);aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PHOTO_LOAD_COMPLETE,c)}}})();(function(){aJSs.JsPhotoTitle=function(b,a){function c(a){if("photoMouseOver"==a.type)u.visible=!0;else if("photoMouseOut"==a.type)u.visible=!1}function d(a){r=o[a.index];if(""!=r){a=u.getChildById("photoTitle");u.removeChild(a);a=new Quark.Bitmap({id:"photoTitle",image:e(q,p,g,l,k,r)});if(s<q)a.x=Math.round((q-s)/2);u.addChild(a);t.visible=!0}else t.visible=!1}function h(a,b,c){var d=document.createElement("canvas");d.width=a;d.height=b;var e=d.getContext("2d");e.fillStyle=c;e.rect(0,0,a,b);e.fill();
...
a.autoSize=!0;c.addChild(a);f=new Image;f.src=d+"res/sound.png";var s=new Quark.MovieClip({image:f,interval:100});s.useHandCursor=!0;s.stop();s.addFrame([{rect:[0,0,32,25],index:0},{rect:[32,0,32,25],index:1}]);a.addChild(s);s.x=c.width-s.width-i;s.y=g+5;"true"!=k&&s.gotoAndStop(1);s.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type)r.Playing()?(s.gotoAndStop(1),r.Pause()):(s.gotoAndStop(0),r.Play())};aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.SOUND_PLAY_COMPLETE,
...
function(){e()})}})();(function(){aJSs.JsThumbnail=function(b,a,c,d){function h(a){B&&B.removeAllChildren();for(var c=0;c<G;c++){var e=a*G+c;if(e<A){var h=new Quark.DisplayObjectContainer({id:"thumBox_"+c});h.autoSize=!0;h.x=(f+o)*c;B.addChild(h);var i=new Quark.Bitmap({id:"thumBg",image:g(f,k,l)});i.autoSize=!0;h.addChild(i);var q=new Image;q.id="img_"+e;q.onload=function(){q.width=f-2*n;q.height=k-2*n;var a=new Quark.Bitmap({id:"thumImg",image:q});a.useHandCursor=!0;a.index=e;a.x=n;a.y=n;h.addChild(a);a.onEvent=function(a){if("mousedown"==
a.type||"touchend"==a.type)a=a.eventTarget,"true"==s?(v.visible=!1,z.visible=!0,b.Show(a.index,1)):(v.changeState("up"),v.visible=!0,z.visible=!1,b.Show(a.index,0))}}();q.src=d+m[e]}}a=new Quark.Bitmap({id:"currentBorder",image:j(f,k,p,n)});a.autoSize=!0;B.addChild(a);Math.floor(E/G)==D?a.x=(f+o)*(E%G):a.visible=!1}function e(){switch(D){case 0:C.changeState("disabled");y.changeState("up");break;case u-1:C.changeState("up");y.changeState("disabled");break;default:C.changeState("up"),y.changeState("up")}}
...
f=a.thumWidth,k=a.thumHeight,l=a.thumbnailBorderColor,p=a.currentBorderColor,n=a.thumborder,o=a.thumSpacing,m=a.thumbnailArray,q=a.startAutoPlay,r=a.continuum,s=a.clickToAutoPlay,t=a.randomPlayingPhotos,u=0,D=0,E=0,A=m.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_CURRENT,function(a){E=a.index;a=Math.floor(E/G);D!=a&&!isNaN(a)&&(D=a,h(D),e());if(B)a=B.getChildById("currentBorder"),a.x=(f+o)*(E%G),!a.visible&&(a.visible=!0);if(E>=A-1&&"false"==r&&"false"==t)v.changeState("up"),
v.visible=!0,z.visible=!1,b.Pause()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){v.changeState("up");v.visible=!0;z.visible=!1;b.Pause()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){v.visible=!1;z.visible=!0;b.Play()});a=new Quark.DisplayObjectContainer({id:"thumbnailBox"});a.autoSize=!0;c.addChild(a);a.x=0;a.y=c.height-i+(i-k)/2;var w=new Image;w.src=d+"res/play.png";var v=new Q.Button({id:"playButton",
image:w,width:32,height:25,up:{rect:[0,0,32,25]},over:{rect:[32,0,32,25]},down:{rect:[64,0,32,25]},disabled:{rect:[96,0,32,25]}});a.addChild(v);v.x=5;v.y=(k-v.height)/2;w=new Image;w.src=d+"res/stop.png";var z=new Q.Button({id:"stopButton",image:w,width:32,height:25,up:{rect:[0,0,32,25]},over:{rect:[32,0,32,25]},down:{rect:[64,0,32,25]},disabled:{rect:[96,0,32,25]}});a.addChild(z);z.x=v.x;z.y=v.y;w=new Image;w.src=d+"res/previousPage.png";var C=new Q.Button({id:"prePageButton",image:w,width:32,height:25,
