<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="addadmin.aspx.cs" Inherits="addadmin" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style3">
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td style="color: #FF3300; font-weight: 700; font-size: large; text-align: center">
    ...
    AutoPostBack="True" Width="217px" ontextchanged="TextBox1_TextChanged"></asp:TextBox>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#FF3300" 
                    NavigateUrl="~/Admin_login.aspx" style="font-weight: 700; font-size: large">Go 
                to login page&gt;&gt;</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
            <td>
