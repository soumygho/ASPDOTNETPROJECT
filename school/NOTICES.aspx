<%@ Page Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="NOTICES.aspx.cs" Inherits="NOTICES" Title="Untitled Page" %>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <asp:Button ID="Button1" runat="server" BackColor="#00FF99" 
                    onclick="Button1_Click" style="font-weight: 700; color: #000066" 
                    Text="UPLOAD" />
            </td>
            <td>
                &nbsp;</td>
