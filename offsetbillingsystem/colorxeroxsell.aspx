<%@ Page Title="" Language="C#" MasterPageFile="~/content.master" AutoEventWireup="true" CodeFile="colorxeroxsell.aspx.cs" Inherits="colorxeroxsell" %>
    ...
    <table class="style5">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:HiddenField ID="categoryid" runat="server"  Value="8"/>
            </td>
            <td>
