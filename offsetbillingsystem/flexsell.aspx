<%@ Page Title="" Language="C#" MasterPageFile="~/content.master" AutoEventWireup="true" CodeFile="flexsell.aspx.cs" Inherits="flexsell" %>
    ...
    <table class="style5">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="textHeight" runat="server" 
                    ontextchanged="textHeight_TextChanged" AutoPostBack="True"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td style="font-weight: 700; font-style: italic">
                WIDTH</td>
            <td>
                <asp:TextBox ID="textWidth" runat="server" ontextchanged="TextBox2_TextChanged" 
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:HiddenField ID="categoryid" runat="server"  Value="2"/>
            </td>
            <td>
