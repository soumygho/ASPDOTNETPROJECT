<%@ Page Title="" Language="C#" MasterPageFile="~/content.master" AutoEventWireup="true" CodeFile="rubberstampsell.aspx.cs" Inherits="rubberstampsell" %>
    ...
    <table class="style5">
        ...
        <tr>
            ...
            <td>
                SELECT MODELNO</td>
            <td>
                <asp:DropDownList ID="stampModelNo" runat="server">
                </asp:DropDownList>
            </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:HiddenField ID="categoryid" runat="server"  Value="5"/>
            </td>
            <td>
