<%@ Page Title="" Language="C#" MasterPageFile="~/content.master" AutoEventWireup="true" CodeFile="passportsizephotosell.aspx.cs" Inherits="passportsizephotosell" %>
 ...
 <table class="style5">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:HiddenField ID="categoryid" runat="server"  Value="6"/>
            </td>
            <td>
