...
using offsetLibrary;
public partial class passportsizephotosell : System.Web.UI.Page
{
    ...
    private void prepareOrder()
    {
        try
        {
          //  Session["bill"] = null;
            ...
            costtable = construct.getPhotoCost(costtable, Int32.Parse(qty.Text));
    ...
    private OrderDetails constructOrder()
    {
        ...
        try
        {
            ...
            orderDetails.Description = "PASSPORT SIZE PHOTO";
